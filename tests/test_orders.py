...
class TestOrders(unittest.TestCase):
    ...
    def test_init_order(self):
        ...
        order_items = [OrderItem(product=1, quantity=1, price=5, status="PLACED")]
    ...
    def test_create_order_with_multiple_items(self):
        ...
        order_item1 = OrderItem(product=1, quantity=1, price=5, status="PLACED")
        order_item2 = OrderItem(product=2, quantity=1, price=5, status="PLACED")
    ...
    def test_deserialize_an_order(self):
        ...
        self.assertEqual(len(order.order_items), 1)
        self.assertEqual(order.order_items[0].item_id, None)
        self.assertEqual(order.order_items[0].product, 1)
    ...
    def test_find_order(self):
        """ Find an Order by ID """
        order_items1 = [OrderItem(product=1, quantity=1, price=5, status="PLACED")]
    ...
    def test_delete_an_order(self):
        """ Delete an Order """
        order_items1 = [OrderItem(product=1, quantity=1, price=5.0, status="PLACED")]
